...
export const DEMO_FIXTURES: [table: string, rows: FixtureRow[]][] = [
  ...
  ['cc_detail_members', [
    ...
    },
    {
      ...
      "department": "设计部",
      "role_title": "视觉设计师",
      "email": "zhenglin@example.com",
      "phone": "13800001010",
      "status": "probation",
      "join_date": "2026-03-19",
      "avatar_color": "#FF7D00",
      "bio": "新入职，负责品牌视觉与营销物料设计。",
      "sort_order": 9,
      "is_active": true
    },
    {
    ...
    },
    {
      ...
      "department": "运营部",
      "role_title": "用户增长专员",
      "email": "hexue@example.com",
      "phone": "13800001012",
      "status": "probation",
      "join_date": "2026-03-17",
      "avatar_color": "#EB2F96",
      "bio": "新入职，负责新用户激活与留存活动。",
      "sort_order": 11,
      "is_active": true
    },
    {
    ...
    },
    {
      ...
      "department": "运营部",
      "role_title": "内容运营",
      "email": "liangjing@example.com",
      "phone": "13800001016",
      "status": "probation",
      "join_date": "2026-02-20",
      "avatar_color": "#4080FF",
      "bio": "负责帮助中心与更新日志的内容维护。",
      "sort_order": 15,
      "is_active": true
    },
    {
