...
export const MENUS_DATA: readonly MenuSeed[] = [
  ...
  { id: 201, name: "组织权限", code: "system_group_org", icon: "IconTeam", path: null, component: null, parent_id: 2, sort_order: 1, menu_type: "menu", is_visible: true, is_active: true },
  { id: 202, name: "安全审计", code: "system_group_security", icon: "IconShield", path: null, component: null, parent_id: 2, sort_order: 2, menu_type: "menu", is_visible: true, is_active: true },
  { id: 203, name: "系统配置", code: "system_group_config", icon: "IconSliders", path: null, component: null, parent_id: 2, sort_order: 3, menu_type: "menu", is_visible: true, is_active: true },
  { id: 204, name: "内容消息", code: "system_group_content", icon: "IconInbox", path: null, component: null, parent_id: 2, sort_order: 4, menu_type: "menu", is_visible: true, is_active: true },
  ...
  { id: 21, name: "用户管理", code: "system_users", icon: "IconUser", path: "/system/users", component: "admin/users", parent_id: 201, sort_order: 1, menu_type: "menu", is_visible: true, is_active: true },
  { id: 22, name: "角色权限", code: "system_roles", icon: "IconIdCard", path: "/system/roles", component: "admin/roles", parent_id: 201, sort_order: 2, menu_type: "menu", is_visible: true, is_active: true },
  { id: 23, name: "菜单管理", code: "system_menus", icon: "IconApps", path: "/system/menus", component: "admin/menus", parent_id: 203, sort_order: 2, menu_type: "menu", is_visible: true, is_active: true },
  { id: 24, name: "日志管理", code: "system_logs", icon: "IconFile", path: "/system/logs", component: "admin/logs", parent_id: 202, sort_order: 2, menu_type: "menu", is_visible: true, is_active: true },
  { id: 25, name: "数据字典", code: "system_dicts", icon: "IconList", path: "/system/dicts", component: "admin/dicts", parent_id: 203, sort_order: 3, menu_type: "menu", is_visible: true, is_active: true },
  { id: 26, name: "部门管理", code: "system_departments", icon: "IconOrg", path: "/system/departments", component: "admin/departments", parent_id: 201, sort_order: 3, menu_type: "menu", is_visible: true, is_active: true },
  ...
  { id: 32, name: "定时任务", code: "system_scheduled_tasks", icon: "IconCalendar", path: "/system/scheduled-tasks", component: "admin/scheduled_tasks", parent_id: 203, sort_order: 4, menu_type: "menu", is_visible: true, is_active: true },
  { id: 100002, name: "消息通知", code: "system_notifications", icon: "IconBell", path: "/system/notifications", component: "admin/notifications", parent_id: 204, sort_order: 2, menu_type: "menu", is_visible: true, is_active: true },
  { id: 100003, name: "公告管理", code: "system_announcements", icon: "IconSend", path: "/system/announcements", component: "admin/announcement_page", parent_id: 204, sort_order: 3, menu_type: "menu", is_visible: true, is_active: true },
