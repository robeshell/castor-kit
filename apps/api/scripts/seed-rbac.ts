...
export const MENUS_DATA: readonly MenuSeed[] = [
  ...
  { id: 26, name: "部门管理", code: "system_departments", icon: "IconOrg", path: "/system/departments", component: "admin/departments", parent_id: 2, sort_order: 2, menu_type: "menu", is_visible: true, is_active: true },
  { id: 27, name: "文件管理", code: "system_files", icon: "IconFolder", path: "/system/files", component: "admin/files", parent_id: 2, sort_order: 6, menu_type: "menu", is_visible: true, is_active: true },
  { id: 28, name: "在线用户", code: "system_sessions", icon: "IconDesktop", path: "/system/sessions", component: "admin/sessions", parent_id: 2, sort_order: 7, menu_type: "menu", is_visible: true, is_active: true },
  { id: 29, name: "系统设置", code: "system_settings", icon: "IconSetting", path: "/system/settings", component: "admin/settings", parent_id: 2, sort_order: 99, menu_type: "menu", is_visible: true, is_active: true },
