...
For example, adding "客户管理" (Customers) under System → Organization (the IDs are for illustration only; see [Menu ID allocation](#menu-id-allocation) below for real values):
...
| Scope | ID range |
|---|---|
| System groups (`parent_id=2`) | 201–209 |
| System pages (`parent_id` = their group, e.g. 201) | 21–39 |
