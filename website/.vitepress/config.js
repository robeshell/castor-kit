...
const zh = {
  ...
  develop: '开发', ai: 'AI 驱动开发', backend: '后端开发', frontend: '前端开发', rbac: '权限 RBAC',
...
const en = {
  ...
  develop: 'Development', ai: 'AI-driven workflow', backend: 'Backend', frontend: 'Frontend', rbac: 'Permissions (RBAC)',
...
const ja = {
  ...
  develop: '開発', ai: 'AI 駆動開発', backend: 'バックエンド', frontend: 'フロントエンド', rbac: '権限（RBAC）',
...
export default defineConfig({
  ...
  locales: {
    root: {
      ...
      lang: 'zh-CN',
      title: 'castor-kit',
      description: 'AI-First 全栈管理脚手架：描述需求，AI 生成完整功能模块并通过门禁验证。',
    ...
    en: {
      ...
      lang: 'en-US',
      title: 'castor-kit',
      description: 'The AI-first full-stack admin scaffold: describe a feature, get a complete, verified module.',
    ...
    ja: {
      ...
      lang: 'ja-JP',
      title: 'castor-kit',
      description: 'AI ファーストのフルスタック管理スキャフォールド。要件を書けば、検証済みのモジュールが完成します。',
